...
<html lang="en">
  <head>
    ...
    <!-- Ion.RangeSlider -->
    <link href="../assets/plugins/normalize-css/normalize.css" rel="stylesheet">
    ...
    <link href="../assets/plugins/cropper/dist/cropper.min.css" rel="stylesheet">
  ...
  <body class="nav-md">
                  ...
                  <div class="row">
                    <div class="col-md-9">
                      <div class="img-container">
                        <img id="image" src="../assets/img/cropper.jpg" alt="Picture">
                      </div>
                    </div>
                    <div class="col-md-3">
    ...
    <!-- Cropper -->
    <script src="../assets/plugins/cropper/dist/cropper.min.js"></script>
